        ...
        <div class="modalBg">
          <div class="modal">
            ...
            <div class="modalInner">
              <div>
                <component :is="item[0]" class="{{title}} { active: hover }" @mouseleave="hover = false" />
              </div>
              <div>
                <h4>{{ item[1] }}</h4>
                <p>{{ item[2] }}</p>
...
<script setup lang="ts">
  ...
  // function isModalOpenFunction(): any {
  //   console.log("isModalOpen() just ran: ")
  //   isModalOpen.value = true
  // }

  function showModal(icon, title, text, open): any {
    // icon = icon.value
    // title = title.value
    // text = text.value
